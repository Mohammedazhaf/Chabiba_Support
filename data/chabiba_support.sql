...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2023 at 07:05 PM
...
INSERT INTO `demande` (`id_demande`, `budget`, `date`, `documentd`, `etat`, `message`, `response_responsable`, `service`, `titre`, `type`, `ver_secretaire`, `id_client`, `creation_date`) VALUES
...
(4, '1000', '2023-06-08', '', 'EnCours', 'Sample message', 'acceptable', 'Maintenance', 'Sample Title', 'Urgent', b'1', 1, '2023-06-08 07:31:07'),
(5, '1000', '2023-06-08', '', 'EnAttente', 'Sample message', 'rejected', 'Maintenance', 'Sample Title', 'Urgent', b'1', 1, '2023-06-08 10:05:39'),
(6, '1000', '2023-06-08', '', 'Termine', 'Sample message', 'acceptable', 'Maintenance', 'Sample Title', 'Urgent', b'1', 1, '2023-06-08 10:05:40'),
(7, '1000', '2023-06-08', '', 'EnCours', 'Need Backlinks for our website', 'acceptable', 'Seo', 'Hello, We need white hat backlinks for our Website.', 'Urgent', b'1', 1, '2023-06-08 10:05:41');
...
--
ALTER TABLE `affectation`
  MODIFY `id_affectation` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `demande`
  MODIFY `id_demande` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
